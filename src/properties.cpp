...
void initProperties(){
	int prop_rents[6] = {0, 0, 0, 0, 0};
	//Go
	PROPERTIES[0] = new Property(0);

	//Mediterranean Avenue
	prop_rents = {2, 10, 30, 90, 160, 250};
	...
	//Baltic Avenue
	prop_rents = {4, 20, 60, 180, 320, 450};
	...
	//Connecticut Avenue
	prop_rents = {8, 40, 100, 300, 450, 600};
	...
	//St. Charles Place
	prop_rents =  {10, 50, 150, 450, 620, 750};
	...
	//Virginia Avenue
	prop_rents = {12, 60, 180, 500, 700, 900};
	...
	//St. James Places
	prop_rents = {14, 70, 200, 550, 750, 950};
	...
	//New York Avenue
	prop_rents = {16, 80, 220, 600, 800, 1000};
	...
	//Kentucky Avenue
	prop_rents = {18, 90, 250, 700, 875, 1050};
	...
	//Illinois Avenue
	prop_rents = {20, 100, 300, 750, 925, 1100};
	...
	//Atlantic Avenue
	prop_rents = {22, 110, 330, 800, 975, 1150};
	...
	//Marvin Gardens
	prop_rents = {24, 120, 360, 850, 1025, 1200};
	...
	//Pacific Avenue
	prop_rents = {26, 130, 390, 900, 1100, 1275};
	...
	//Pennsylvania Avenue
	prop_rents = {28, 150, 450, 1000, 1200, 1400};
	...
	//Park Place
	prop_rents = {35, 175, 500, 1100, 1300, 1500};
	...
	//Boardwalk
	prop_rents = {50, 200, 600, 1400, 1700, 2000};
